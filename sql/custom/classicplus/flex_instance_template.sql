...
INSERT INTO `flex_instance_template` (`map_id`, `player_count`, `hp_multi`, `dmg_multi`, `xp_multi`, `comment`) VALUES
	(36, 1, 0.33, 0.33, 0.33, 'Deadmines - 1M'),
	(36, 2, 2, 2, 1, 'Deadmines - 2M+'),
	(409, 1, 0.1, 0.1, 1, 'Molten Core - 1M'),
	(409, 2, 0.2, 0.2, 1, 'Molten Core - 2M+');